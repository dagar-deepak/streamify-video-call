...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 md:p-8" data-theme="forest">
      ...
      {/* 👇 Footer - Made by Deepak Dagar */}
      <footer className="mt-6 text-center text-xs text-primary/70 italic">
        Made by Deepak Dagar
      </footer>
    </div>
  );
};
